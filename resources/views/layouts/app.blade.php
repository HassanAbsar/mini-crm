...
{{-- <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notificationsDropdown">
        @forelse ($notifications as $notification)
            <li>
                <a class="dropdown-item" href="{{ route('leads.show', $notification->data['lead_id']) }}">
                    {{ $notification->data['message'] }} - <strong>{{ $notification->data['name'] }}</strong>
                </a>
            </li>
        @empty
        ...
        @endforelse
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @forelse ($notifications as $notification)
                                    <a class="dropdown-item d-flex align-items-center" href="{{ route('leads.show', $notification->data['lead_id']) }}">
                                        <div class="mr-3">
                                        ...
                                        <div>
                                            ...
                                            <span class="font-weight-bold">{{ $notification->data['message'] }} - <strong>{{ $notification->data['name'] }}</strong></span>
                                        </div>
                                    </a>
                                @empty
